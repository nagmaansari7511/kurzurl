...
public class IDConverter {
	...
	//create a function that takes in a request number (ID) and converts it into a unique URL:
	...
	//create a function to do the reverse: take in a unique URL and return the request number (id):
