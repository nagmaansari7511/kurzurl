package com.kurzurl.kurzurl.controller;

import com.kurzurl.kurzurl.Logic.Logic;
import com.kurzurl.kurzurl.dto.ShortenUrlRequest;
import com.kurzurl.kurzurl.service.IUrlStoreService;
...
public class UrlController {
    ...
    public ModelAndView shortenUrl(HttpServletRequest httpRequest,
        ...
        if (!bindingResult.hasErrors()) {
            final String id = new Logic().getShort(url);
